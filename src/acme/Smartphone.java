...
public class Smartphone {
	 ...
	 * @param provincia el país en el que desea buscar correcaminos
	 ...
	 */
	public String locateRoadRunner(String city, String provincia) throws IOException {
	...
	/**
        ...
        /**
         * Dispara al correcaminos con la cantidad de voltios que se especifiquen.
         * <p>
         * No exceda más de 30 voltios o la función de zap será contraproducente.
         * </p>
         * @param voltage  Indica el número de voltios que se enviarán al cuerpo del correcaminos.
         * @throws IOException lanza excepción si no se introduce un valor entero
         * para el numero de voltios
         * @see prepareTrap
         */
